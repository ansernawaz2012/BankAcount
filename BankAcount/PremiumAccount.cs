...
namespace BankAcount
{
    ...
    {
        public string AccountType { get; } = "Premium";
        public double Balance { get; set; } = 0;
        public int OverdraftLimit { get; } = 5000;
        public string CCType { get; } = "Gold";
        ...
        public PremiumAccount(string firstName, string lastName, long accountNumber)
        {
